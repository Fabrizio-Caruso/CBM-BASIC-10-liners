...
7pOp+t,7:?"{home}{reverse on}{red}g{green}e{cyan}m{purple}s{white}"j" {blue}hi{cyan}"r" {yellow}{reverse off}b{green}{reverse on}"x:ifd>laNgtHpOv,9:pOv,.:dA"{24}{60}{24}{102}{153}{24}{36}{102}"
