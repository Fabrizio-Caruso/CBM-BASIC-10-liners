...
5gEa$:hh=-7705*(d=1):if(d=1)or(iaN1)=0tHifrN(1)>.2tHc$=cH(w+(faN1))+"Q":f=f+1
6?sPo);l$;sPs);c$;sPb-s);r$:pOh,93:pOh+t,8:ifa$<>""tHc=aS(a$)-k:p=p+(c=2)-(c=4)
7g=p+t-1-j*x:pOg,j:pOg+2,j:?"{home}{down}{left}{148}":pOz,x:pOp+t,2:pOp,m:ifpE(p-e)=ytHl=9
8h=hh+o+int(b/2):?"{home}{red}";l;" {cyan}pts{purple}";i;" {cyan}hi{purple}";r:ifo>1-dtHifo+d+b<16tHo=o-1+d
