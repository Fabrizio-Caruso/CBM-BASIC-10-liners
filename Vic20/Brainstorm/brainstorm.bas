0dIp(99):dIc$(99):dId$(99):z=65:fOi=.to5:p(i+z)=.:nE:t=0:q=0:g=32:o(1)=14:goS7
1o(.)=5:h=70:goS8:input"{down*4}{purple}>";a$:a$=a$+"  ":f=aS(mI(a$,1,1)):s=aS(mI(a$,2,1))
2on-(((f=g)or(f<z)or(f>h)or(f=s))or((s<>g)aN(s<z)or(s>h))or(p(f)<>t))gO1
...
9pO38476+22*i,3:pO7756+22*i,102:nE:?sPo(t));"{green}{223}{210*2}{169}":v=36879:pOv,25:pO19,1:reT