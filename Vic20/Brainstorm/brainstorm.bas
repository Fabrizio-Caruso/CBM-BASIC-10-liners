...
3on-((s<>g)aN(p(s)<>t))gO1:p(f)=(p(f)+1)aN1:p(s)=(p(s)+1)aN1:t=(t+1)aN1:fOw=.to1
4m(w)=.:c(w)=.:fOi=.to2:m(w)=m(w)+((p(i+z)+w)aN1):c(w)=c(w)+((p(i+68)+w)aN1)
5nE:nE:q=q+1:on-((m(.)<>c(.))or(c(.)<3))gO6:goS8:?"{down*2}{blue}done in"q"steps!":goS7:rU
