...
1s=3:fOi=1to16:rEe:pO7167+i,255-e:nE:s$="{home}{down*3}{reverse on}        {white}step{yellow}":dA17,,254,,,70,136
2fOi=.to3:p(i)=1:p(6-i)=0:nE:c(0)=3:c(1)=5:?"{clear}{reverse on}  {cyan}{reverse off}@{green}a{reverse on} {white}vic {green}fruzzle {cyan}{reverse off}@{green}a"
