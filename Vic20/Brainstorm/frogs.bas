0v=36878:t=30720:pOv+1,110:b=7816:c=b+12:z=65:q=.:g=160:dimc(160):pOv-9,255
...
5fOi=.to6:pOb+t+i*2,c(p(i)):pOb+i*2,p(i):nE:?s$;q;:data"{238}{170}{238}{255}{1}{255}{255}{185}","{119}{85}{119}{255}{128}{255}{255}{157}"
...
9s=f:pOj,g:on-(p(0)=1orp(1)=1orp(2)=1orp(4)*p(5)*p(6)=0orp(3)<2)gO5:?"done!":gO5