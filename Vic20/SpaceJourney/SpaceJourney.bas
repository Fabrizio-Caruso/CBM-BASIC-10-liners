...
3i=i+1:b=int(i/512):fOk=.tob:?j$tAint(rN(.)*d))"{white}{67}":nE:if(iaN127)=.tHb$="{yellow}{66}"
4if(iaN31)=.tHs=int(rN(.)*d):?j$tAs)b$;:if(iaN511)=.tH?tAs)"{left}{purple}{64}":dA153,,8,28,28
