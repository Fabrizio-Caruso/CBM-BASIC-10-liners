0pO56,26:pO52,26:v=36878:x=132:pOv-9,255:fOp=.to39:rEb:pO7168+p,b:nE:e=22:z=218
1a=127:o=4:y=7:b=7:p=8174:pO650,z:?"{clear}{black}{reverse on}use j l":l$="{green}{68*2}{black}{66}":r$="{black}{67}{green}{68*2}":ifi>rtHr=i
...
3b=b+f:i=i+1:if(iaNy)=ytHd=int(rN(.)*3):ifb<4tHifo<7tHb=5:dA24,189,255,165,36
4s=int(rN(.)*(b+1)):ifpE(p-e)<>32tHpOn,42:pOv,15:pOv,.:l=l+1:fOf=-9tox:nE:pOn,59
5c$=" ":gEa$:ifiaN1tHc$="{31}@":ifl<.tHl=.:dA189,255,165,90,102,90,60,36,219,255
...
8?"{home}{red}a{reverse on}"l" {purple}"i" {black}"r:f=(iaNa)=.:l=l+f:ifo>1-dtHifo+d+b<17tHo=o-1+d:dA83,33,8,28
