0d=1:pO56,26:pO52,26:v=36878:x=132:pO646,1:pOv-9,255:fOp=.to39:rEb:pO7168+p,b:nE
1e=22:a=127:y=7:z=218:b=9:p=8174:pO650,z:?"{clear}":l$="{green}{68*2}{black}{66}":r$="{black}{67}{green}{68*2}":ifi>rtHr=i
...
3b=b+f:i=i+1:if(iaNy)=ytHd=int(rN(.)*3):ifb<5tHifo<6tHb=b+1:y=3:dA24,189,255,165
