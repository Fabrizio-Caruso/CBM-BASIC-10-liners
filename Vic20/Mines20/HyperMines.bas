...
1a=418:d=8164:o=7745:j=.:m=87:p=7955:z=3:b=90:w=36:u=22:kk=1:goS44
2t=30720:h=81:x=1:i=32:b1=.94:b2=.975:bp=100:?"{clear}":goS20:fOq=.tob:pOo+1+fnrf(a),m:nE
3rem
4rem
5ifpE(p)=wtHpOv,15:j=j+4:pOv,0:pO7680,b:pO7680+t,2:fOq=.tob:nE:iff>.tHf=f-1
6goS43:ifpE(p)=88tHj=j+14:goS19:pOp,h:goS20
7z=z-zz:ifpE(p)=83tHj=j+19:goS18:pOp,b:pOp-23,i:pOp-21,i:pOp+21,i:pOp+23,i:goS19
8pO38421,2-5*zz:pO7701,z+48:?"{home}{yellow}${white}"9-f"{white}"j" {cyan}hi{white}"r
9l=jjaNll:c=2:ifrN(1)>.1tHq=p-4+2*fnrf(5)+44*(fnrf(3)-1):pOq,m:pOq+t,1
10s=.:gEa$:pOp,h:pOp+t,1:ifa$<>""tHs=aS(a$):e=saN1:c=s-75+e:pOv,15:pOv,.
11y=.:pOn,8:ifsG(c)=ctHy=1:pOp,m:p=p+c*(21*e+1):j=j+1:jj=jj+1:ifz>9tHz=9
12pOp+t,2+kc:pOg+t,7:pOg,w:g=7680:ifj>=k*bptHk=k+1:pOn,k:f=.:kc=kc+1:ifkc>5tHkc=.
13zz=.:on-(z=.)gO21:if-ytHifl=lltHg=o+1+fnrf(a):pOg+t,4:pOg,b
...
16zz=j>=500*kk:ifjj>x*150tHx=x*1.45:ll=7-8*(x>3):ifx>2tHo=o+u:d=d-u:a=a-44:goS20
17kk=kk-zz:on-((p<daNp>o)aN(pE(p)<>m))gO5:pOn,.:f=.:z=z-1:pOp,i:p=7955:goS22:gO5
...
20fOq=.tou+1:pOo-q+t,1:pOd+q+t,1:pOo-q,102:pOd+q,102:nE:reT
