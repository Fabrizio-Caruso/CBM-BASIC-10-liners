0pO56,27:pO52,27:x=rN(-rnd(0)):fOp=0to15:rEb:pO7168+p,b:nE:pO646,1
1dEfnrf(x)=int(rN(1)*x):v=36878:pOv-9,255:rem dIch(77):ch(73)=1:ch(75)=0:ch(74)=0:ch(76)=0
2ll=7:k=1:n=v+1:zz=15:a=418:d=8164:pOn,8:ifj>rtHr=j:?"{clear}{reverse on}record!":fOi=0to999:nE
...
5ww=150:bb=500:wr=1.45:g0=7680:g1=7701:gt=38421:cc=88+128:s=75
6rem h=ch(s)
...
10z=z-zz:ifpE(p)=83tHj=j+19:goS30:pOp,b:pOp-23,i:pOp-21,i:pOp+21,i:pOp+23,i:goS31
...
14y=.:pOn,8:ifsG(c)=ctHy=1:pOp,m:p=p+c*(21*e+1):j=j+1:jj=jj+1:ifz>9tHz=9
...
18ifs=iaNf<9tHpOn,10:pOp,b:pOp-1,67:pOp+1,67:pOp-u,66:pOp+u,66:goS34:f=f+1:pOn,8
19zz=j>=bb*kk:ifjj>x*wwtHx=x*wr:ll=7-8*(x>3):ifx>2tHo=o+u:d=d-u:a=a-44:zz=15:goS32:zz=.
20kk=kk-zz:on-((p<daNp>o)aN(pE(p)<>m))gO6:pOn,.:f=.:z=z-1:pOp,i:p=p0:goS34:gO6
30pOp,b:fOqq=.toa/8:q=o+1+fnrf(a):pOq,86:pOv,15:pOv,.:pOq,i:nE:reT
31pOp,b:fOqq=-2to2:fOq=-1to1:oo=p+qq+u*q:pOv,15:pOv,.:pOoo,86:pOoo,i:nE:nE:reT
...
34pOp,b:pOp-1,i:pOp+1,i:pOp-u,i:pOp+u,i:on-((p<o+u)or(p>d-u))goS32:reT
...
46?"{reverse on}              {purple}jkl":?"{down*2}{white}{reverse on}   use {yellow}${white} with {purple}space" :?"{down*3}{green}{reverse on}   prepare to start"
47goS58:reT
58?"{down*3}{right*6}{white}{reverse on} press a key":wA198,1:pO198,.:reT
...
80dA 24, 36, 24,102,153, 24,36,102
85dA 24, 60, 24,102,153, 24,36,102
90rem dA$18,$24,$18,$66,$99,$18,$24,$66