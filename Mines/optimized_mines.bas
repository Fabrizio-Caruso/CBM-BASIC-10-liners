...
1t=v-24:p=1524:o=1143:fOi=1too:nE:h=81:?"{clear}":q=1:fOi=0to39:pOo-i,102:pOd+i,102:nE
...
4l=jaN1:z=j>w:pOp,h:gEa$:s=.:y=.:ifa$<>""tHs=aS(a$):e=saN1:ifj>m+htHl=-1
...
8pOo+g+t,7:if-ytHifztHifltHg=int(rN(0)*760):pOo+g+t,4:pOo+g,w
