...
5z=s-75+e:ifsG(z)=ztHy=1:poKv,15:poKv,.:i=m:a=p:c=1:goS9:p=p+z*(78*e+1):j=j+1:q=q-.001
...
8on-((p<daNp>o)aN(peE(p)<>m))gO2:b=b-1:f=.:i=h:a=p:c=2:goS9:on-(b>0)gO2:?"{home}{down}{white}end":gEkEa$:r=-j*(j>r)-r*(j<=r):j=.:gO0
