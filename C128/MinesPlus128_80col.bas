0q=.7:b=3:bo$="":p=9102:qq=8429:of=128:pp=1501:fA:gR5,1:o=8428:n=53280:poKn,0:poKn+1,0:g=o-209:fOi=.topp:poKqq+i,.:nE
...
2v=54296:m=87:d=9930:h=81:w=36:u=32:?"{home}"spC27)"{yellow}$:{white}"9-f"{red}{Q}:{white}"b"{cyan}  score:{white}"j"  {cyan}hi:{white}"r:ifpeE(p)=wtHj=j+4:iff>0tHf=f-1
