...
5?"{light gray}1. attack":?"2. run":inputa:a=aaN1:l=int(s-r*n+n+rN(.)*4):ifaaNl<.tH?"{red}you are hit for";-l"pts":e=e+l:sL1:dA"kobolds"
6on-(e<.ors>99)gO9:ifatH?"{cyan}you kill the "e$(r):s=s+1:p=2+int(rN(.)*r):?"you get{yellow}"p;"{brown}$":g=g+p:sL2:gO8:dA"{green}dark woods"
7m=l+9*(r=1)-2*n:ifm<.tH?"{red}they grab you and take";-m+1"pts":e=e+m-1:sL1:gO5:else?"{cyan}you escape":sL1:dA"{yellow}heavy sword"
