...
4fOk=.to1:fOi=1toj*3:?"{clear}"j$(j)"{home}{down}{white}day {gray}"i;q$:r=1+int(rN(.)*(j+1)):n=2+int(rN(.)*(3*j+1)):?"you are attacked by"n;e$(r)
5?"{light gray}1. attack":?"2. run":inputa:a=aaN1:l=r*n-int(rN(.)*n*9):ifaaNs<ltH?"{red}you are hit for";l-s"pts":e=e-l+s:sL1:dA"kobolds"
...
8nE:p=j*int(10+rN(.)*19):ifk=.tHq$=" return":?"{clear}at the end you find{yellow}";p;"{brown}$":g=g+p:sL2:nE:else:q$="":s=s+1:nE:w(1)=j:gO1
