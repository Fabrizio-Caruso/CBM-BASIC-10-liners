...
1o=1143:z=19:f=86:s=128:r=2047:?"  joy2":reAa$:fOi=.totstEe:c=3581+i*8:fOk=3to66
...
4poKo-39*k+g*i,f:nE:nE:sP8,1,3,,,.:dA"12345678901234567890123456789012"
...
7j=jO(2)aN7:x=x+e*m:y=y+e*l:ifu=ftHh=.:elsenE:a=d+q/f:c=1+(y-g)/b:q=q+1
8chA,d+rN(.)*t,d+rN(.)*z,b$+"W":?" "spC15)"W "p"  S "h:ifjtHpoKr,b+(j+1)/2
9b$=cH(n+(qaN1)):on-(bU(1)<saNh>.)gO5:h=h-1:on-(h>.)gO5:sL4:mO8,x(1),y(1):rU