...
1s=128:r=2047:?"{purple}{clear}{cyan}joy2":fOi=1to5:c=3520+i*64:o=1143:fOk=.to63:poKc+k,.:nE:reAa$
...
9b$=cH(158+(qaN1)):on-(bU(1)<saNh>.)gO5:h=h-1:on-(h>.)gO5:sL4:mO8,x(1),y(1):rU