0fast:graphic5,1:of=128:b=8192:o=239:n=53280:poken,0:poken+1,0:v=54296:w=36:g=o-216:h=81:d=1840:ifj>rthenr=j:print"{clear}{cyan}record!":fori=1tob/4:next
1print"{clear}{gray}use ijkl space":p=1000:fori=240to1759:pokeb+i,32:next:m=87:k=1:q=.9:j=.:print"{clear}{down}";spc(32);"{gray}{119}{119}{119} {red}mines {gray}{119}{119}{119} (fc)"
...
8on-((p<dandp>o)and(peek(p+b)<>m))goto2:f=.:i=h:a=p:c=1+k:gosub9:print"{home}{down}the end":getkeya$:goto0
