...
7i=w:a=g:c=7:gosub9:g=o-216:if-ythenifl=3theng=o+1+int(rnd(0)*1520):i=90:a=g:c=4:gosub9
8on-((p<dandp>o)and(peek(p+b)<>m))goto2:f=.:pokep+b,h:print"{home}{down}the end":fori=1tob/4:next:goto0
9color 5,c+1:ay=int(a/80): ax=a-ay*80:pokea+b,i:char 1,ax,ay,chr$(i+128):return
