...
1print"{clear}{white}use ijkl space":p=910:fori=8429to9929:pokei,0:next:m=87:k=1:q=.8:j=.:print"{clear}{down}";spc(32);"{gray}{119}{119}{119} {red}mines {gray}{119}{119}{119}     (fc)"
