0fast:graphic5,1:of=128:b=8192:o=236:n=53280:poken,0:poken+1,0:v=54296:w=36:g=o-213:h=81:d=1817:ifj>rthenr=j:print"{clear}{cyan}record!":fori=1tod:next
1print"{clear}{white}use ijkl space":p=910:fori=8429to10008:pokei,0:next:bo$="":fori=1to79:bo$=bo$+"{230}":next:m=87:k=1:q=.8:j=.:print"{clear}{down}";spc(32);"{gray}{119}{119}{119} {red}mines {gray}{119}{119}{119}     (fc)":print bo$:char1,0,23,bo$
2print"{home}";spc(23);"{yellow}$:{white}";9-f;"{cyan}  score:{white}";j;"  {cyan}high score:{white}";r:ifpeek(p+b)=wthenj=j+4:iff>0thenf=f-1
3l=jand3:s=.:ifrnd(ti)>qthenx=p-4+2*int(rnd(ti)*5)+158*(int(rnd(ti)*3)-1):i=m:a=x:c=1:gosub9
...
7of=0:i=w:a=g:c=7:gosub9:of=128:g=o-213:if-ythenifl=3theng=o+1+int(rnd(ti)*1520):i=90:a=g:c=4:gosub9
