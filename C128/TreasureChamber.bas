...
1o=1143:z=19:f=86:s=128:r=2047:?"{light green}{clear}{cyan}joy2":reAa$:fOi=.totstEe:c=3581+i*8:fOk=.to64
...
8chA,d+rN(.)*t,d+rN(.)*z,b$+"W":?"{home}"spC15)"W{white}"p" {red}S{white}"h:ifjtHpoKr,b+(j+1)/2
