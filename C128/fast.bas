...
1w=1601:y=162:x=156:?"{green}{clear}":f=102:fOi=1to5:s=3520+i*64:fOk=.to63:poKs+k,.:nE:reAa$
2e=8:b=56:fOk=0to23stE3:poKs+k,aS(mI(a$,1+k/3,1)):nE:d=38:nE:t=32:z=17:fOi=1to8
...
7h=-h*(u<>f):x=x+e*m:y=y+e*l:j=jO(2)aN7:ifu=87tHp=p+1:vO9:vO.:poKw,t:a=4+q/99
8nE:chA,4+rN(.)*t,5+rN(.)*z,"{yellow}W":?"{home}"spC16)"{yellow}W{white}"p" {red}S{white}"h:ifjtHpoK2047,b+(j+1)/2
