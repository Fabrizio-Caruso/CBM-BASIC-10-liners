...
4if(qaN63)=1tHpoKw,32:w=1104+int(rN(.)*920):poKw,90:mO8,x,y:l=1:dA129,90,36,36
5x(i)=x(i)+4*sG(x-x(i)):y(i)=y(i)+4*sG(y-y(i)):if(jaN1)=1tHpoK2047,64-j:dA60,
6mOi,x(i),y(i):nE:ifbU(2)=128tHif-ltHl=.:p=p+1:poKw,32:?"{home}  {yellow}score{white}"p
7on-(bU(1)<128)gO3:end:dA24,60,24,102,153,24,36,102,2,24,52,25,118,152,24,20,20
8fOk=0to23stE3:poKs+k-1,.:reAa:poKs+k,a:poKs+k+1,.:nE:fOk=23to63:poKs+k,.:nE:reT
9dA4,24,36,24,102,153,24,36,102,6,24,44,152,110,25,24,40,40