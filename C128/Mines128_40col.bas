...
1w=36:g=o+b:h=81:t=v-24:d=1904:print"{clear}{gray}use ijkl space":p=1524:getkeya$:m=87:k=1
...
4l=jand3:s=.:ifrnd(1)>qthenx=p-4+2*int(rnd(1)*5)+80*(int(rnd(1)*3)-1):pokex,m:pokex+t,1
