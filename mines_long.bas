...
80ify=1andj>40thenpoke1024+int(rnd(0)*1000),36:ifpeek(p)=36thenj=j+5
90ify=1thenq=q-0.01:j=j+1:y=0:ifpeek(p)=mthenfori=1tou:next:j=0:f=0:goto10
99on-(p<d and p>u)goto20:j=j+50:ifj>rthenr=j:?"{clear}bonus points!":fori=1tod:next:j=0:f=0:goto10
