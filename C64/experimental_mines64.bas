...
1q=0.95:g=b:v=54296:h=81:t=v-24:d=1904:?"{clear}{gray}use ijkl space{light gray}":w=36:fOi=1top:nE
...
4ifrN(0)>qtHx=p-4+2*(int(rN(0)*5))+80*((int(rN(0)*3))-1):pOx,87:pOx+t,1
5l=jaN3:gEa$:s=.:y=.:pOp,h:pOp+t,1:ifa$<>""tHs=aS(a$):e=saN1
6c=s-75+e:ifsgn(c)=ctHy=1:pOv,15:pOv,0:pOp,87:p=p+c*(39*e+1):j=j+1:q=q-.001
7pOp+t,2:pOo+t+g,7:pOo+g,w:g=b:if-ytHifl=3tHg=int(rN(0)*780):pOo+t+g,4:pOo+g,90
