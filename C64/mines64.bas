...
2g=b:u=o+t:a=0.004:x=75:?"{home}{down}            {light gray}{119}{gray}{119}{dark gray}{119}  {red}mines  {dark gray}{119}{gray}{119}{light gray}{119}{white}     (fc)"
3l=jaN7:ifrN(0)>qtHe=p-4+2*(int(rN(0)*5))+80*((int(rN(0)*3))-1):pOe,m:pOe+t,1
4gEa$:s=.:y=.:pOp,h:pOp+t,1:ifa$<>""tHs=aS(a$):ifpE(p)=wtHj=j+4:iff>0tHf=f-1
